...
async function ensureColumnExists(db: any, table: string, column: string, definition: string): Promise<void> {
  try {
...
ctx.waitUntil(
      ...
      if (inter.type === 2 && inter.data?.name === "forge") {
      ...
      if (inter.type === 2 && inter.data?.name === "shop") {
      ...
      if (inter.type === 2 && inter.data?.name === "settings") {
